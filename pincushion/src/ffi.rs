...
pub fn sample_points(
    ...
    seed: TaggedOption<u64>
) {
    mesh.set_sampled_points(area, sampled_points, sampled_normals, get_seed(seed));
}
...
pub fn sample_triangles(
    ...
    mesh.set_sampled_triangles(area, sampled_triangles, get_seed(seed));
}

fn get_seed(seed: TaggedOption<u64>) -> Option<u64> {
    match seed {
        TaggedOption::Some(seed) => Some(seed),
